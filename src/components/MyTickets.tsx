...
const MyTickets = () => {
  ...
  return (
    <section id="my-tickets" className="py-20 relative overflow-hidden">
      {/* Parallax Background */}
      <div 
        className="absolute inset-0 bg-gradient-to-br from-emerald-100/60 via-teal-50/60 to-cyan-100/60"
