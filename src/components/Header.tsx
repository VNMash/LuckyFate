  ...
  return (
    <header className="sticky top-0 z-50 border-b border-red-700/10 shadow-lg overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Top edge animation */}
        <div 
          className="absolute top-0 left-0 right-0 h-full bg-gradient-to-b from-amber-900/90 via-amber-800/70 to-transparent backdrop-blur-md transition-all duration-700 ease-out"
          style={{
