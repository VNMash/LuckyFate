  ...
  return (
    <header className="sticky top-0 z-50 border-b border-red-700/10 shadow-lg overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div 
          className="absolute bottom-0 left-0 right-0 h-full bg-gradient-to-t from-amber-200/90 via-amber-100/70 to-transparent backdrop-blur-md transition-all duration-700 ease-out"
          style={{
            clipPath: scrollDirection === 'down'
